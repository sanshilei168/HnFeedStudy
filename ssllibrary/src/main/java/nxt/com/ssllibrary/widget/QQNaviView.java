...
public class QQNaviView extends LinearLayout {
    ...
    public QQNaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mIconWidth = ta.getDimension(R.styleable.QQNaviView_iconWidth, dp2px(context, 35));
        mIconHeight = ta.getDimension(R.styleable.QQNaviView_iconHeight, dp2px(context, 35));
