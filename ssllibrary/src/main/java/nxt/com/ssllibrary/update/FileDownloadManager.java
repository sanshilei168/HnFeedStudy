...
import nxt.com.ssllibrary.SslConstant;
...
//        file:///storage/emulated/0/Download/update.apk 
        req.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, SslConstant.FILE_NAME+"_update.apk");
//        第三种 自定义文件路径
//       req.setDestinationUri(Uri.parse("file:///storage/sdcard1/Download/funiu.apk"));
        // 设置一些基本显示信息
        req.setTitle(title);
